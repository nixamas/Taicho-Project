...
//	private double _animTotalTime;
	...
	public StateMenu(Taicho freegemas) {
		super(freegemas);
...
//		_fontLoading = Freegemas.getPlatformResolver().loadFont("data/loadingFont.fnt", "data/normal.ttf", 70);
		...
		_options.add(new Pair(_lang.getString("Lets Play"), "StateGame"));
//		_options.add(new Pair(_lang.getString("How to play"), "StateHowto"));
		_options.add(new Pair(_lang.getString("How to play"), "StateGameOverMenu"));
...
//		_imgBackground = new TextureRegion(assetManager.get("data/taicho_banner.png", Texture.class));
...
//	    batch.setColor(1.0f, 1.0f, 1.0f, (float)1);
